...
typedef struct ticket{
  ...
  pthread_cond_t cond;      // Mutex para controlar a fila de clientes.
} ticket_t;
...
typedef struct toy{
  ...
  pthread_cond_t cond;      // Condição para controlar alguma execução.
  pthread_mutex_t mtx_cond; // Mutex para controlar a condição de um brinquedo.
